...
export default function ReciptePage() {
  ...
  return(
    ...
    <div className="w-[550px] h-auto flex flex-col justify-start items-start bg-(--card-bg) rounded-xl p-6 space-y-5 select-none">
      ...
      <span className="text-xs font-semibold">An easy and quick dish, perfect for any meal. This classic omelette combines beaten eggs cooked 
      ...
      <div className="w-full h-auto bg-[#ee82b228] px-5 py-3 rounded-lg">
        <span className="text-(--text-accent) font-bold text-2xl">Preparation time</span>
      ...
      <span className="text-2xl font-bold text-(--text-titles)">Ingredients</span>
      <div className="">
        <ul>
      ...
      <span className="text-2xl font-bold text-(--text-titles)">Instructions</span>
      ...
      <span className="text-2xl font-bold text-(--text-titles)">Nutrition</span>
