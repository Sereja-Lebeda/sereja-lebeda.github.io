...
export default function ArticlePreview() {
  ...
  return (
    <>
      <Link to={"/"}>
        <span className="text-blue-700 text-lg select-none mx-4">Get back</span>
      </Link>

      <div className="w-[750px] h-[300px] bg-white rounded-2xl flex justify-center items-center mx-4">
        <img
          src="subDomains\newbie\article-preview\images\drawers.jpg"
          alt=""
          className="rounded-l-2xl h-[300px] w-[290px] "
        />
          ...
          <div className="w-full h-full flex flex-col justify-start items-start gap-4">
            ...
            <div className="w-full h-full flex justify-between items-center gap-4">
              <div className="flex items-center gap-4">
                <img
                  src="subDomains\newbie\article-preview\images\avatar-michelle.jpg"
                  alt=""
              ...
              <div className="relative" ref={shareContainerRef}>
                <button
                  className="group w-8 h-8 border-2 border-(--text-primary) rounded-full flex justify-center items-center cursor-pointer select-none hover:bg-(--text-primary)"
                  ...
                  <>
                    <div className="absolute bottom-full left-1/2 -translate-x-1/2 w-[220px] h-[60px] mb-4 bg-(--card-bg) rounded-2xl select-none">
                      <div className="flex justify-between items-center select-none p-4">
                        ...
                        <a href="#">
                          <img
                            src="subDomains\newbie\article-preview\images\icon-facebook.svg"
                            alt="Facebook"
                        ...
                        <a href="#">
                          <img
                            src="subDomains\newbie\article-preview\images\icon-twitter.svg"
                            alt="Twitter"
                            className="hover:scale-[1.4]"
                          />
                        </a>
                        <a href="#">
                          <img
                            src="subDomains\newbie\article-preview\images\icon-pinterest.svg"
                            alt="Pinterest"
                            className="hover:scale-[1.4]"
                          />
                        </a>
                      ...
                      <div
                        className="absolute left-1/2 top-15 -translate-x-1/2 w-0 h-0 border-l-[8px] border-l-transparent
